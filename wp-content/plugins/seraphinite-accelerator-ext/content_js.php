...
function Scripts_Process( &$ctxProcess, $sett, $settCache, $settContPr, $settJs, $settCdn, $doc )
{
	...
	foreach( $items as $item )
	{
		...
		if( $src )
		{
			...
			$cont = null;
			$contMimeType = null;
			if( ($srcInfo[ 'filePath' ]??null) && Gen::GetFileExt( $srcInfo[ 'filePath' ] ) == 'js' )
			{
