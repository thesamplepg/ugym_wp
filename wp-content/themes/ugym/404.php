  ...
  <div class="comtainer mx-auto h-dvh">
    <div class="w-full h-full flex items-center justify-center">
      <div class="p-10 bg-white rounded-2xl shadow-sm flex flex-col items-center">
        <svg class="size-16 text-amber-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a class="text-amber-500 mt-1" href="<?php echo home_url(); ?>">На главную</a> 
      </div>
    </div>
  </div>
